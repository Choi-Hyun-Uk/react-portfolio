...
const intro = [
  {
    ...
    content: [
      ...
      `당연하게도 결과물은 저도 그렇지만, 컨텐츠를 기획한 담당자 또한 100% 마음에 들어하지 않았었습니다.`,

      `작업 외에 기획에 대해서 물어보는 대화가 작업하는 과정보다 더 많은 에너지를 소비해야 했기 때문이었습니다.`,

      `그 당시에는 업무 요청에 정의된 문서가 없었기 때문에 생긴 문제가 아니었을까 생각이 들었고, 더 나은 협업을 위해
      업무요청서를 만든 뒤 현재 위와 같은 문제가 발생이 되기 때문에 여러 팀에게 공유를 드린 경험이 있습니다.`,

      `솔직히 어떤 결과가 나올지는 상상할 수 없었습니다. 제가 벌린 일이 더 안좋은 결과를 나타내지 않을까 했습니다.
      하지만, 다행스럽게도 업무요청서 라는 간단한 문서로 인해 서로간의 소통도 원활하게 이어지게 되었고,`,

      `원활한 소통으로 더 나은 협업으로 이루어져 좋은 결과물을 보여지게 되고, 당시 쇼핑몰 고객들에게 재미있고, 좋은 컨텐츠를
      경험할 수 있도록 하지 않았을까 싶습니다.`,

      `또한 이러한 과정에서 기획 담당자와 디자이너간에 의견이 맞지 않을 수도 있겠지만 이런 부스팅도 협업의 과정이라 생각합니다.`,
